...
class Simulation:
    ...
    def get_car_count_in_node(self, node_id: int) -> int:
        return len(self.__nodes[node_id].car_ids)

    def get_car_capacity_of_node(self, _node_id: int) -> int:
        return len(self.__cars)  # not needed yet, but may be needed in the future?
